...
var WxgamePlugin = /** @class */ (function () {
    ...
    WxgamePlugin.prototype.onFinish = function (pluginContext) {
        return __awaiter(this, void 0, void 0, function () {
            var projectRoot, outputDir, buildConfig, gameJSPath, gameJSContent, projectConfig, optionStr, reg, replaceStr, orientation, gameJSONPath, gameJSONContent, engineVersion, libDir, pluginData, engineJS, signatureData, i, name_1, jsInfo;
            return __generator(this, function (_a) {
                ...
                libDir = path.join(outputDir, "egret-library");
                fs.mkdirSync(libDir);
                pluginData = { "main": "index.js" };
